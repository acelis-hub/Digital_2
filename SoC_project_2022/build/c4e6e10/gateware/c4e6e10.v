...
wire [7:0] csrbank4_in_r;
reg  csrbank4_in_we = 1'd0;
wire [7:0] csrbank4_in_w;
wire csrbank4_sel;
...
reg  [7:0] multiregimpl1_regs0 = 8'd0;
reg  [7:0] multiregimpl1_regs1 = 8'd0;
...
assign csrbank4_in_r = interface4_bank_bus_dat_w[7:0];
always @(*) begin
	csrbank4_in_re <= 1'd0;
	csrbank4_in_we <= 1'd0;
...
assign csrbank4_in_w = switchs_status[7:0];
...
assign switchs_status = multiregimpl1_regs1;
...
always @(posedge sys_clk) begin
	...
	multiregimpl1_regs0 <= {sw7, sw6, sw5, sw4, sw3, sw2, sw1, sw0};
	multiregimpl1_regs1 <= multiregimpl1_regs0;
	multiregimpl2_regs0 <= {btnl, btnr, btnc};
...
initial begin
	$readmemh("c4e6e10_sram.init", sram);
end
reg [10:0] sram_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[0])
...
initial begin
	$readmemh("c4e6e10_main_ram.init", main_ram);
end
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-06-09 09:55:30.
//------------------------------------------------------------------------------
