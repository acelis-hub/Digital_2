...
reg  builder_csrbank6_orden0_re = 1'd0;
wire [2:0] builder_csrbank6_orden0_r;
reg  builder_csrbank6_orden0_we = 1'd0;
wire [2:0] builder_csrbank6_orden0_w;
...
reg  builder_csrbank11_mem_adr0_re = 1'd0;
wire [18:0] builder_csrbank11_mem_adr0_r;
reg  builder_csrbank11_mem_adr0_we = 1'd0;
wire [18:0] builder_csrbank11_mem_adr0_w;
reg  builder_csrbank11_mem_we0_re = 1'd0;
wire builder_csrbank11_mem_we0_r;
reg  builder_csrbank11_mem_we0_we = 1'd0;
wire builder_csrbank11_mem_we0_w;
reg  builder_csrbank11_mem_data_w0_re = 1'd0;
wire [11:0] builder_csrbank11_mem_data_w0_r;
reg  builder_csrbank11_mem_data_w0_we = 1'd0;
wire [11:0] builder_csrbank11_mem_data_w0_w;
reg  builder_csrbank11_mem_data_r_re = 1'd0;
wire [11:0] builder_csrbank11_mem_data_r_r;
reg  builder_csrbank11_mem_data_r_we = 1'd0;
...
assign builder_csrbank4_sel = (builder_interface4_bank_bus_adr[13:9] == 3'd6);
...
assign builder_csrbank6_orden0_r = builder_interface6_bank_bus_dat_w[2:0];
always @(*) begin
	builder_csrbank6_orden0_we <= 1'd0;
	builder_csrbank6_orden0_re <= 1'd0;
	if ((builder_csrbank6_sel & (builder_interface6_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank6_orden0_re <= builder_interface6_bank_bus_we;
		builder_csrbank6_orden0_we <= (~builder_interface6_bank_bus_we);
	end
end
assign builder_csrbank6_orden0_w = basesoc_pwm_cntrl_storage[2:0];
...
always @(*) begin
	builder_csrbank11_mem_adr0_re <= 1'd0;
	builder_csrbank11_mem_adr0_we <= 1'd0;
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank11_mem_adr0_re <= builder_interface11_bank_bus_we;
		builder_csrbank11_mem_adr0_we <= (~builder_interface11_bank_bus_we);
	end
end
assign builder_csrbank11_mem_we0_r = builder_interface11_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank11_mem_we0_we <= 1'd0;
	builder_csrbank11_mem_we0_re <= 1'd0;
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csrbank11_mem_we0_re <= builder_interface11_bank_bus_we;
		builder_csrbank11_mem_we0_we <= (~builder_interface11_bank_bus_we);
	end
end
assign builder_csrbank11_mem_data_w0_r = builder_interface11_bank_bus_dat_w[11:0];
always @(*) begin
	builder_csrbank11_mem_data_w0_re <= 1'd0;
	builder_csrbank11_mem_data_w0_we <= 1'd0;
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank11_mem_data_w0_re <= builder_interface11_bank_bus_we;
		builder_csrbank11_mem_data_w0_we <= (~builder_interface11_bank_bus_we);
	end
end
assign builder_csrbank11_mem_data_r_r = builder_interface11_bank_bus_dat_w[11:0];
always @(*) begin
	builder_csrbank11_mem_data_r_we <= 1'd0;
	builder_csrbank11_mem_data_r_re <= 1'd0;
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 2'd3))) begin
		builder_csrbank11_mem_data_r_re <= builder_interface11_bank_bus_we;
		builder_csrbank11_mem_data_r_we <= (~builder_interface11_bank_bus_we);
	end
end
...
always @(posedge sys_clk) begin
	...
	if (builder_csrbank6_sel) begin
		case (builder_interface6_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface6_bank_bus_dat_r <= builder_csrbank6_orden0_w;
			end
		endcase
	end
	if (builder_csrbank6_orden0_re) begin
		basesoc_pwm_cntrl_storage[2:0] <= builder_csrbank6_orden0_r;
	end
	basesoc_pwm_cntrl_re <= builder_csrbank6_orden0_re;
	...
	basesoc_mem_data_r_re <= builder_csrbank11_mem_data_r_re;
	if (sys_rst) begin
...
//------------------------------------------------------------------------------
// Memory mem: 307200-words x 12-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
...
reg [18:0] mem_adr1;
always @(posedge sys_clk) begin
	mem_adr0 <= basesoc_p_r_adr;
end
always @(posedge sys_clk) begin
	if (basesoc_p_w_we)
		mem[basesoc_p_w_adr] <= basesoc_p_w_dat_w;
	mem_adr1 <= basesoc_p_w_adr;
end
assign basesoc_p_r_dat_r = mem[mem_adr0];
assign basesoc_p_w_dat_r = mem[mem_adr1];
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-06-26 16:29:37.
//------------------------------------------------------------------------------
